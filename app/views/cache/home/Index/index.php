    ...
    <div class="container-fluid">
        ...
        <div class="chat-user">
            <div class="chat-con">
                ...
                <div class="right-con">
                   <span>同志</span><img src="/themes/index/images/icon-call.png" /> 您好，欢迎来到求真的世界，务实的港航，请问我能为您提供什么服务？
                </div>
            </div>
		...
		<div>
		<?php if($val["id"] > 1 && $val["id"] < 4) {?>
			<?=$val["title"]?>
		<?php } elseif($val["id"] == 4) {?>
			<?php foreach($val["list"] as $res) {?>
			<li><?=$res["title"]?></li>
			<?php }?>
		<?php }?>
		</div>
